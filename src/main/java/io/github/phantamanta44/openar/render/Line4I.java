...
public class Line4I {
	...
	public Line4I(int x1, int y1, int x2, int y2, BeamColor color) {
		this(x1, y1, x2, y2, color.getColor());
	}
	...
	public Line4I(int x1, int y1, int x2, int y2, float[] color) {
		this(x1, y1, x2, y2, color[0], color[1], color[2], 0.60F);
	}
	...
	public Line4I(int x1, int y1, int x2, int y2, float r, float g, float b, float a) {
		this.x1 = x1;
		this.x2 = x2;
		this.y1 = y1;
		this.y2 = y2;
